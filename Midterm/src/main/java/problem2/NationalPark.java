...
public class NationalPark {
  ...
  public NationalPark(String nationalParkID, String nationalParkName, String state,
      Double area,
      LocalDate dateParkFounded, String[] visitorCenters, Boolean
      openYearRound) {
