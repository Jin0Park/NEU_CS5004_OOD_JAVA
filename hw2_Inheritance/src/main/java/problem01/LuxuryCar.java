...
/**
 * CS5004 Spring2022 Jin Young Park hw2 LuxuryCar.java
 * LuxuryCar is a child class of Vehicle and inherits the fields from Vehicle class.
 * The maximum occupancy, whether it needs special driver's license,
 * and whether it allows different pickup and dropoff locations are set as constant.
 */
public class LuxuryCar extends Vehicle {
  ...
  /**
   * Constructor of LuxuryCar class
   *
   ...
   *                   it throws exception since it is invalid input   */
  public LuxuryCar(Double dailyPrice, int numOfBookedDays)
