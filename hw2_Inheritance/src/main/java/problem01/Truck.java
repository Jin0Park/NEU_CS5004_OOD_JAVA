...
/**
 * CS5004 Spring2022 Jin Young Park hw2 Truck.java
 *
 * Truck is a child class of Vehicle and inherits the fields from Vehicle class. The maximum
...
public class Truck extends Vehicle {
  ...
  private static final boolean needSpecialDL = true;
   ...
   *                   it throws exception since it is invalid input   */
  public Truck(Double dailyPrice, int numOfBookedDays)
