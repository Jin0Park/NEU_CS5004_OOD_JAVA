...
public class ElementSetNode extends AbstractSet{
    ...
    public Set add(Integer element) {
        if (this.contains(element))
            return this;
        else return new ElementSetNode(element, this);
    }
    ...
    @Override
    public Integer size() {
        return this.getPointerToRest().size();
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(element, that.element) && Objects.equals(pointerToRest, that.pointerToRest);
    }
