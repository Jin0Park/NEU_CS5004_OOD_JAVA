...
public class ElementListOfLists extends AbstractListOfLists{
    private ListOfIntegers listElement;
    private ListOfLists pointerToRest;

    public ElementListOfLists(ListOfIntegers listElement, ListOfLists pointerToRest) {
        this.listElement = listElement;
        this.pointerToRest = pointerToRest;
    }

    public ElementListOfLists(ListOfIntegers listElement) {
        this.listElement = listElement;
        this.pointerToRest = new EmptyListOfLists();
    }

    public ListOfIntegers getListElement() {
        return listElement;
    }
    ...
    public ListOfLists removeAllIntegers(Integer element) {
        if (this.listElement.contains(element))
            return new ElementListOfLists(this.listElement.remove(element), this.pointerToRest.removeAllIntegers(element));
        else
